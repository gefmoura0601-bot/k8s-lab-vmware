...
RECOMMENDATION_LABELS = {
    ...
    "Replace wildcards with exact API groups, resources, resourceNames and verbs.": "Substitua wildcards por API Groups, resources, resourceNames e verbos exatos.",
    ...
    "Review every cluster-admin subject and prefer scoped roles with time-bound elevation.": "Revise todos os sujeitos com cluster-admin e prefira Roles com escopo e elevação temporária.",
    ...
    "Scope verbs/resources/resourceNames and review every bound subject.": "Restrinja verbos, resources e resourceNames e revise todos os sujeitos vinculados.",
...
def pt_text(value: Any) -> Any:
    ...
    substitutions = (
        ...
        (r"^(\d+) role\(s\) with wildcard verbs/resources; sample=(.+)$", r"\1 Role(s) com verbos/recursos wildcard; amostra=\2"),
